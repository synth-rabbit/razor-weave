...
## Workflow Run
- Run ID: wfrun_michsgzr_w4v28x
- Book: Razorweave Core Rulebook (core-rulebook)
- Chapters to modify: 5

## Improvement Plan Summary
Address newcomer accessibility and usability by improving character creation flow, adding combat quick-reference, and enhancing resolution examples.

### Target Issues
| ID | Severity | Description |
|----|----------|-------------|
| issue-001 | high | Nine-step character creation process is overwhelming; example character Rella appears only after all steps |
| issue-002 | high | Combat introduces many concepts at once; Resolve Clock stakes discussion buried in prose; lacks concrete damage numbers |
| issue-003 | medium | Resolution procedure lacks consolidated walkthrough; when-to-roll criteria too subjective; attribute selection guidance too light |
| issue-004 | medium | Dual-clock pattern buried in prose; emotional Conditions lack roleplay guidance; Tag effects use ambiguous language |
| issue-005 | low | Attribute scale feels compressed; Working with Low Attributes section needs deeper character expression guidance |
