...
## Workflow Run
- Run ID: wfrun_mic5vslx_4umpzj
- Book: Razorweave Core Rulebook (core-rulebook)
- Chapters to modify: 4

## Improvement Plan Summary
Address mechanical clarity gaps in core rules chapters, focusing on DC guidance, Check procedures, combat mechanics, and Character Creation flow to improve Persona Fit and Practical Usability scores from 6.2 to target 8.0.

### Target Issues
| ID | Severity | Description |
|----|----------|-------------|
| issue-001 | high | DC guidelines lack concrete number ranges and context-specific guidance, leaving GMs uncertain about difficulty assignment |
| issue-002 | high | Check resolution procedure lacks clear step-by-step breakdown; partial success outcomes leave too much to GM interpretation |
| issue-003 | high | Character creation optimization pathways unclear; attribute allocation guidance sparse for new players |
| issue-004 | high | Combat action economy described conceptually rather than procedurally; Resolve Clock advancement rates undefined |
| issue-005 | medium | Tags, Conditions, and Clocks interactions unclear; mechanical effects need quick reference |
