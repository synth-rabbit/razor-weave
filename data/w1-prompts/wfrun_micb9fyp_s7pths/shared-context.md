...
## Workflow Run
- Run ID: wfrun_micb9fyp_s7pths
- Book: Razorweave Core Rulebook (core-rulebook)
- Chapters to modify: 5

## Improvement Plan Summary
Address critical usability gaps in combat, character creation, and mechanics chapters through concrete benchmarks, clarified terminology, and quick-reference elements to improve practical usability and persona fit.

### Target Issues
| ID | Severity | Description |
|----|----------|-------------|
| issue-001 | high | Resolve Clocks lack standardized benchmarks and concrete sizing guidelines, making combat feel too abstract for players accustomed to HP systems |
| issue-002 | high | Skills vs Proficiencies distinction is initially confusing; no numeric Skill values specified during creation |
| issue-003 | high | Three parallel tracking systems (Tags, Conditions, Clocks) create cumulative cognitive load during actual play |
| issue-004 | medium | Margin thresholds and outcome tiers require memorization; Edge/Burden stacking lacks worked examples |
| issue-005 | medium | GMless, solo, and asynchronous play modes are mentioned but lack dedicated mechanical support or procedures |
