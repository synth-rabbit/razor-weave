...
This project contains all materials for creating, editing, and publishing the
Razorweave TTRPG system and setting books.

### Start Here

- **For Humans**: See [README.md](README.md) for project overview and getting started
- **For Agents**: See [AGENTS.md](AGENTS.md) for agent instructions and
  workflows
...
I need to implement some styleguides for the project and introduce things like
linters.
