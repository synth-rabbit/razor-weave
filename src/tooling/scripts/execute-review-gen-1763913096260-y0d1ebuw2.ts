...
// Database connection - go up to project root
const projectRoot = join(import.meta.dirname, '..', '..', '..');
const dbPath = join(projectRoot, 'data', 'project.db');
...
// Write markdown file
const markdownPath = join(projectRoot, 'data/reviews/raw/campaign-20251123-192801-j6p4e486/gen-1763913096260-y0d1ebuw2.md');
